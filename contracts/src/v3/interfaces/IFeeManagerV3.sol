...
interface IFeeManagerV3 {
    ...
    event FeesDeposited(
        address indexed token, address indexed curve, bool indexed isBuy, uint256 protocolFee, uint256 creatorFee
    );
    ...
    function depositFees(address token, uint256 protocolFee, uint256 creatorFee, bool isBuy) external payable;
