...
export type Token = { address: string; creator: string; name: string; symbol: string; initial_supply: string; description?: string; image_url?: string; metadata_url?: string; website_url?: string; x_url?: string; telegram_url?: string; discord_url?: string; created_at: BlockRef; metrics: TokenMetrics; curve?: { address: string; sold_supply: string; reserve_balance: string; supply?: string; starting_price?: string; slope?: string; graduation_threshold?: string; lifecycle?: string }; graduation?: { phase: string; liquidity_token?: string; token_amount?: string; quote_amount?: string; liquidity_amount?: string; lock_id?: string; unlock_timestamp?: number } };
