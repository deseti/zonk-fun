...
export type TokenMetrics = { trade_count: number; buy_count: number; sell_count: number; volume: string; fees: string; unique_trader_count: number; latest_trade_timestamp: number | null; current_price: string | null; market_cap: string | null; holder_count: number | null };
