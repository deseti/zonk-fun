...
const tokenSchema = z.object({ address: z.string(), creator: z.string(), name: z.string(), symbol: z.string(), initial_supply: z.string(), created_at: z.object({ block_number: z.number(), transaction_hash: z.string(), log_index: z.number() }), metrics: z.object({ trade_count: z.number(), buy_count: z.number(), sell_count: z.number(), volume: z.string(), fees: z.string(), market_cap: z.string().nullable(), holder_count: z.number().nullable() }), curve: z.object({ address: z.string(), sold_supply: z.string(), reserve_balance: z.string() }).passthrough().optional(), graduation: z.object({ phase: z.string() }).passthrough().optional() });
